...
<body>
    <div>
        <div data-aos="fade-down" data-aos-duration="650" data-aos-once="false" id="heading-bar">
            <nav class="bg-shagayu container-fluid text-light  d-none d-md-block">
                <div class="container py-1">
                    <span class="mx-md-5 mx-2 "><small><b>Shagayu Company Ltd - Construcion and Electrical Solutions</b></small></span>
                    <span class="mx-md-5 mx-2 text-light"><a href="tel:+255784669055" class=" text-light "><small><i class="fa fa-phone text-light mx-2" aria-hidden="true"></i> Sales</small></a> | <a href="tel:+255" class=" text-light "><small>Sales 2</small></a></span>
                    <span class="mx-md-5 mx-2"><a href="mailto:sales@shagayu.co.tz" class=" text-light "><small><i class="fas fa-mail    mx-2"></i> sales@shagayu.co.tz</small></a></span>
                </div>
            </nav>
